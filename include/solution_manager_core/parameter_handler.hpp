...
#ifndef SOLUTION_MANAGER_CORE__PARAMETER_HANDLER_HPP_
#define SOLUTION_MANAGER_CORE__PARAMETER_HANDLER_HPP_
...
#endif  // SOLUTION_MANAGER_CORE__PARAMETER_HANDLER_HPP_
