...
#ifndef SOLUTION_MANAGER__ROBOT_MANAGER_NODE_HPP_
#define SOLUTION_MANAGER__ROBOT_MANAGER_NODE_HPP_
...
#include "solution_manager_core/ros2_base_lc_node.hpp"

using CallbackReturn = rclcpp_lifecycle::node_interfaces::LifecycleNodeInterface::CallbackReturn;

namespace solution_manager_core
{
class RobotManagerNode : public solution_manager_core::ROS2BaseLCNode
{
public:
  RobotManagerNode();
...
#endif  // SOLUTION_MANAGER__ROBOT_MANAGER_NODE_HPP_
